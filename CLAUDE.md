...
- **Current version: 1.15.1** (web app survives an API outage: timeouts on server-side fetches + error boundaries instead of a raw Vercel 504, 2026-07-29; keep this line in sync on every bump).

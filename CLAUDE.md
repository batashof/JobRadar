...
- **Current version: 1.13.0** (board quality gate — shared description sanitizer, RemoteOK deactivated, Himalayas added, WWR/Jobicy multi-feed, ADR-016, 2026-07-28; keep this line in sync on every bump).
